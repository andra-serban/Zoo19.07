...
namespace Zoo19._07.Controllers
{
    public class MainsController : Controller
    {
        ...
        public MainsController(ZooContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var main = await _context.Main
                .FirstOrDefaultAsync(m => m.Ancora == id);
            if (main == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Ancora,Idindivid,Idzoo")] Main main)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Ancora,Idindivid,Idzoo")] Main main)
        {
            if (id != main.Ancora)
            {
                return NotFound();
